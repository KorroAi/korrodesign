...
Same prompt. Same product. One generated by vanilla AI, the other with Korrodesign enforcing every rule.

<p align="center">
  <strong>❌ WITHOUT Korrodesign</strong><br>
  <img src="demo/before.png" alt="Without Korrodesign — typical AI slop" width="800">
  <br><em>Purple gradient, Inter font, emoji CTAs, centered white text on color, default Tailwind palette, fake testimonials.</em>
</p>

<p align="center">
  <strong>✅ WITH Korrodesign</strong><br>
  <img src="demo/after.png" alt="With Korrodesign — premium, distinctive, production-ready" width="800">
  <br><em>Cabinet Grotesk + Satoshi, custom emerald palette, grain overlay, asymmetric layout, Three.js 3D scene, shadow-as-border, no emoji, no purple, concrete copy.</em>
</p>

[View the live HTML demos →](demo/)
